                ...
                <div className="bg-white rounded-lg border border-waqf-border p-8 md:p-12">
                    ...
                    <div className="space-y-6">
                        <a
                            ...
                            className="flex items-start gap-4 p-5 rounded-md border border-waqf-border hover:border-primary-500/50 transition-colors group"
                        >
                            <div className="w-11 h-11 rounded-md bg-primary-600/10 text-primary-600 flex items-center justify-center shrink-0 transition-colors">
                        ...
                        <div className="flex items-start gap-4 p-5 rounded-md border border-waqf-border">
                            <div className="w-11 h-11 rounded-md bg-amber-50 text-amber-600 flex items-center justify-center shrink-0">
